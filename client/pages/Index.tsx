import { Calendar, MapPin, ExternalLink, Users, Hash, Mail, MessageSquare, Clock, ChevronRight, Search, Bell, Star } from "lucide-react";
      ...
      <nav className="bg-white border-b border-gray-100 px-3 py-3">
        <div className="max-w-[1920px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-400 hidden sm:block">8:53 AM EDT</span>
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="mt-4 bg-blue-50/80 backdrop-blur-sm border border-blue-200/30 rounded-xl p-3 flex items-center justify-between">
                <p className="text-[#2F7CA9] text-sm">
                  You have manage access<br />for this event.
                </p>
                <Button size="sm" className="bg-[#007AD6] hover:bg-[#0066BB] text-white h-7 px-3 text-xs">
                  Manage
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-[#004D8D]/80 mb-0.5">Presented by</p>
                  <div className="flex items-center gap-1">
                    <p className="text-[#000061] text-sm font-medium">AI Tinkerers - Ottawa</p>
              ...
              <div className="relative">
                <div className="h-17 overflow-hidden relative">
                  ...
                  <p className="text-[#004D8D]/80 text-sm leading-relaxed">
                    We host cool AI events in Ottawa. Our promise is to provide a stage for open-source AI developers to share code and the lessons they've learned from experimentation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#000061]/8 pb-2">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">Hosted By</h3>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#000061] text-sm font-medium">Neilda Pacquing Gagné</span>
                  </div>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#000061]/8 pb-2">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">16 Went</h3>
              </div>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" className="text-[#000061]/36 border-[#000061]/8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[#000061] text-sm font-medium">Wednesday, August 20</p>
                    <p className="text-[#004D8D]/80 text-sm">5:00 PM - 6:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      <p className="text-[#000061] text-sm font-medium">Invest Ottawa</p>
            ...
            <div className="bg-white/50 backdrop-blur-sm border border-white/30 rounded-xl p-4 shadow-sm">
              <div className="bg-[#00325966]/4 rounded-t-lg px-4 py-2 -mx-4 -mt-4 mb-3">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">Registration</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 border-b border-[#000061]/8">
                  ...
                  <div>
                    <p className="text-[#000061] text-sm font-medium">Past Event</p>
                    <p className="text-[#004D8D]/80 text-sm">This event ended 2 days ago.</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <span className="text-[#000061] text-sm font-medium">Mohamed hatem Diabi</span>
                      <span className="text-[#004D8D]/80 text-sm ml-1">medhatem2@gmail.com</span>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#000061]/8 pb-2">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">About Event</h3>
              </div>
              
              <div className="space-y-4 text-[#000061] text-sm leading-relaxed">
                <p>
                  Join a collaborative session designed to help you clarify, simplify, and strengthen how you talk about what you're building.
                </p>
                
                <p>
                  You'll pitch your project twice in small rotating groups, get actionable feedback from peers, and leave with sharper storytelling skills and fresh inspiration.
                </p>
                
                <div>
                  <p className="font-semibold mb-2">Why join</p>
                  <p>✓ Practice explaining your project in just 4 minutes<br />
                  ✓ Get thoughtful, constructive feedback from other builders<br />
                  ✓ Learn from 6+ real startup pitches<br />
                  ✓ Discover new ways to communicate your vision</p>
                </div>
                
                <div>
                  <p className="font-semibold mb-2">How it works</p>
                  <p>→ Small groups of 4<br />
                  → 4-minute pitch + 5 minutes of feedback<br />
                  → Rotate and repeat<br />
                  → Bonus tips from Eduardo Bailetti on effective pitching</p>
                </div>
                
                <p>
                  Whether you're refining your narrative or just starting out, this is a great space to learn, connect, and grow alongside other founders and builders.
                </p>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#000061]/8 pb-2">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">Blasts</h3>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#004D8D]/80 text-xs">Yesterday, 7:14 PM</span>
                  </div>
                  
                  <div className="space-y-4">
                    <h4 className="text-[#000061] text-base font-semibold">Pitch Practice Recap</h4>
            ...
            <div className="space-y-4">
              <div className="border-b border-[#000061]/8 pb-2">
                <h3 className="text-[#004D8D]/80 text-sm font-medium">Location</h3>
              </div>
              
              <div className="space-y-4">
                <div>
                  <p className="text-[#000061] text-sm font-medium">Invest Ottawa</p>
                  <p className="text-[#004D8D]/80 text-sm">7 Bayview Station Rd, Ottawa, ON K1Y 2C5, Canada</p>
                </div>
